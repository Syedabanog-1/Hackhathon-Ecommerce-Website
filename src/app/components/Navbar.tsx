        ...
        <div>
            ...
            <div className="h-[50px] w-full bg-[#7E33E0] flex items-center justify-between px-5 sm:px-8">
                ...
                <div className="flex items-center space-x-4">
                    <Link href={"/user"}>
                        <button aria-label="User" className="p-2 hover:bg-black/5 rounded-full transition-colors">
            ...
            <div className="w-full bg-white flex items-center justify-between px-4 sm:px-8 relative">
                ...
                {/* Mobile Menu Button */}
                <button className="sm:hidden text-[#7E33E0] text-3xl" onClick={() => setMenuOpen(!menuOpen)}>
                    {menuOpen ? "✕" : "☰"}
                </button>

                {/* Navigation Links */}
                <div
                    className={`${menuOpen ? "flex" : "hidden"} sm:flex flex-col sm:flex-row absolute sm:static top-[100%] left-0 w-full sm:w-auto bg-white sm:bg-transparent z-10 sm:space-x-6`}
                >
                    {[
                        { href: "/", label: "Home" },
                        ...
                        <Link key={link.href} href={link.href} className="text-[#0D0E43] font-[Lato] text-sm px-4 py-2 sm:px-0">
                            {link.label}
                        </Link>
                    ))}
                </div>
